...
import { createStockMutation } from "./graphql/mutations";
const client = generateClient();
export default function StockMutationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCorrections(initialValues.corrections);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createStockMutation.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "StockMutationCreateForm")}
      {...rest}
    >
      <TextField
        label="Location"
